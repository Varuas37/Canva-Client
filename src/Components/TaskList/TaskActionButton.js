...
function TaskActionButton({ list, addList, addCards, listID }) {
	...
	const handleSubmit = () => {
		...
		list ? addList(formData) : addCards(listID, formData);
		setFormData('');
		setFormOpen(false);
	};
...
export default connect(mapStateToProps, { addList, addCards })(TaskActionButton);
