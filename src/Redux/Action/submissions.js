...
import { GET_SUBMISSIONS, ERR_GET_SUBMISSIONS, POST_CANVAS_COMMENT, POST_CANVAS_COMMENT_ERR } from './types';
...
export const postSAPComments = (data) => async (dispatch) => {
	try {
		await axios.post(`http://localhost:3300/api/canvas/submissions/SAPComments`, data);
		dispatch({
